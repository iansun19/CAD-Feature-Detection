...
try:
    ...
    from brep.step_ingest import _surface_type_code, face_mid_normal, load_step_shape, sprops
...
def brep_extent_along_direction(
    ...
    *,
    ...
    from brep.brep_extents import axis_extent, resolve_occ_faces
...
def validate_face_indices(
    ...
    *,
    ...
    """
    from brep.brep_extents import FaceIndexError
...
def _resolve_occ_faces(step_path, face_ids, *, expected_n_faces):
    from brep.brep_extents import resolve_occ_faces
