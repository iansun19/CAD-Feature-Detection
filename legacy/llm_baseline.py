...
from legacy.evaluate import load_class_names, per_class_metrics
from legacy.dataset import _brep_bounds, _edge_set, _canonical_edge, SPLIT_H5
from brep.taxonomy import NEW_DESCRIPTIONS, NUM_CLASSES
