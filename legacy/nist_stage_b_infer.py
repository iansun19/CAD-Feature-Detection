...
from brep.feature_graph import build_feature_graph, summarize_graph, write_feature_graph  # noqa: E402
from brep.feature_instances import union_find_instances  # noqa: E402
from legacy.model import BRepGNN  # noqa: E402
from brep.taxonomy import NEW_NAMES, NUM_CLASSES, OLD_TO_NEW, validate  # noqa: E402
...
OUT_FEATURE_GRAPH = os.path.join(ROOT, "fixtures/graphs/fixtures/graphs/nist_ctc_01_feature_graph.json")
NUM_OLD = 25
