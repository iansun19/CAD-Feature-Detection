...
Gate probe (no retuning): re-ran area (8%), XZ (3 mm), normal-dot (0.85) checks from `scripts/96260B/kept_front_resolution_96260B.py` against front contour_surface candidates.
