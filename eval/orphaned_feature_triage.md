...
| rear  | class-only drops | [17, 36, 37, 102, 103, 104] | **resolved** â€” no longer in drop list | -6 rear false drops |
...
| **37** (rear lateral edge) | **IN** (rear -Z) | **OUT** (front 37 is different face, -Z only) | **Remains flagged** â€” rear assignment is ray-test suspect; not forced across panels |
...
**Front reachability gap (unchanged):** `[25, 26, 34, 36, 37]` â€” all `-Z`-only on
