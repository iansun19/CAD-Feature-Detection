...
from cascade.coaxial_stack_detection import CoaxialStackDetectionConfig, detect_coaxial_stack
from cascade.flats_detection import FlatDetectionConfig, detect_flats
from cascade.hole_detection import HoleDetectionConfig, detect_holes
from cascade.outer_fillet_detection import OuterFilletDetectionConfig, detect_outer_fillets
...
from cascade.profile_detection import ProfileDetectionConfig, detect_profiles
from cascade.residual_detection import ResidualDetectionConfig, detect_residual_candidates
from cascade.wall_detection import WallDetectionConfig, detect_walls
...
def _face_axial_mm(
    ...
    from cascade.lobe_tier_detection import _axial_y
...
def _lobe_tier_provenance(
    ...
    *,
    ...
    from cascade.lobe_tier_detection import LobeTierConfig, detect_filleted_lobe_tiers
    from cascade.pocket_detection import FaceGraph
