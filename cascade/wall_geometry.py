...
def _wall_depth_mm(
    ...
    from cascade.pocket_detection import _depth_below_top_mm
...
def _convex_summary_safe(face_id: int, ctx: _WallGeomContext) -> Any | None:
    from cascade.stock_cut_classification import _convex_summary
...
def resolve_opening_axis(
    ...
    *,
    ...
    if wall_axes:
        from cascade.setup_descriptor import auto_detect_opening_axis
...
def build_wall_geom_context(
    ...
    *,
    ...
    from cascade.pocket_detection import _part_axis_top
    from cascade.stock_cut_classification import _load_cad
