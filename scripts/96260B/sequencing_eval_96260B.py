...
from planning.machining_context import build_context_v0, load_feature_graph  # noqa: E402
from planner import SetupPlanInput, plan_multi_setups  # noqa: E402
from planning.sequence_search import validate_sequence_precedence  # noqa: E402
...
def main() -> int:
    ...
    example = load_cam_plan(REPO_ROOT / "examples/cam_plan_96260B_rear.json")
